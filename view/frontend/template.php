        ...
        <div class="container">
          ...
          <div class="jumbotron p-3 p-md-5 text-white rounded bg-dark">
            <div class="col-md-6 px-0">
              <h1 class="display-4 font-italic">Le blog de l'écrivain Jean Forteroche</h1>
              <p class="lead my-3">Voici le lieu où vous pourrez enfin lire les histoires de mon voyage en Alaska.</p>
            </div>
          </div>
